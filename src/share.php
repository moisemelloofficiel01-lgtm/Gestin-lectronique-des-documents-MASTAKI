            ...
            <div class="modal-body p-4">
                <form id="shareDocumentForm">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="multi-select-dropdown" id="msDocShare">
                            ...
                            <button type="button" class="btn btn-white border w-100 text-start d-flex justify-content-between align-items-center dropdown-toggle" data-bs-toggle="dropdown">
                                <span class="ms-label">Sélectionner des utilisateurs</span>
                        ...
                        <small class="text-muted">Cocher pour sélectionner plusieurs</small>
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body p-4">
                <form id="shareCategoryForm">
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold">Partager avec</label>
                        <div class="multi-select-dropdown" id="msCatShare">
                            <input type="hidden" name="shared_with" class="ms-values" value="[]">
                            <button type="button" class="btn btn-white border w-100 text-start d-flex justify-content-between align-items-center dropdown-toggle" data-bs-toggle="dropdown">
                                <span class="ms-label">Sélectionner des utilisateurs</span>
                                <span class="badge bg-primary ms-count rounded-pill d-none">0</span>
...
$(document).ready(function() {
    ...
    $('#shareDocumentForm').on('submit', function(e) {
        ...
        const data = {
            ...
            document_id: $('#share_doc_select').val(),
            shared_with: getMultiSelectValues('msDocShare'),
    ...
    $('#shareCategoryForm').on('submit', function(e) {
        e.preventDefault();
        const data = {
            action: 'share_category',
            category_id: $('#share_cat_select').val(),
            shared_with: getMultiSelectValues('msCatShare'),
            permission: $(this).find('select[name="permission"]').val()
        };
...
function loadUsersAndDocs() {
    ...
    initMultiSelect('msDocShare', 'api/share/?action=users');
    initMultiSelect('msCatShare', 'api/share/?action=users');
