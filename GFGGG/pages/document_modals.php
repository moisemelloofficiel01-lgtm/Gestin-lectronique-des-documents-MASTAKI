            ...
            <div class="modal-body p-4">
                <form id="addDocumentForm" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3 montant-group" data-categories="FACTURE,DEVIS,BON_COMMANDE,BON_LIVRAISON">
                            <label class="form-label fw-bold">Date du Document</label>
                            <input type="date" class="form-control" name="date_facture" id="add_date_facture">
                        </div>
                        ...
                        <div class="col-md-6 mb-3 montant-group" data-categories="FACTURE,DEVIS,BON_COMMANDE,BON_LIVRAISON">
                            ...
                            <input type="date" class="form-control" name="date_echeance" id="add_date_echeance">
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-body p-4">
                <form id="editDocumentForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Date du Document</label>
                            <input type="date" class="form-control" name="date_facture" id="edit_date">
                        </div>
            ...
            <div class="modal-body p-4">
                <form id="shareDocumentForm">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="shared_with" id="share_user_select_modal" required>
...
function shareDocument(id) {
    ...
    $('#share_doc_id').val(id);
    $.ajax({
        url: 'api/share/?action=users',
        type: 'GET',
        dataType: 'json',
        success: function(response) {
            console.log('[DocModal] SHARE users response:', response);
            if (response.status === 'success') {
                ...
                $('#share_user_select_modal').html(opts);
            }
        }
    });
