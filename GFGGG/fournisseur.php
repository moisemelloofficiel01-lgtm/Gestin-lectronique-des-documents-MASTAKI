<?php include('pages/header.php'); ?>
        ...
        <div class="page-wrapper">
            ...
            <div class="content pb-0">
                ...
                <div class="campaign-tab">
                    <ul class="nav nav-tabs nav-bordered mb-4">
                        <li class="nav-item">
                            <a href="campaign.html" class="nav-link active bg-transparent text-primary">Active Campaign<span class="fs-10 fw-normal ms-1 text-body">24</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="campaign-complete.html" class="nav-link bg-transparent">Completed Campaign</a>
                        </li>
                        <li class="nav-item">
                            <a href="campaign-archieve.html" class="nav-link bg-transparent">Archived Campaign</a>
                        </li>
                    </ul>
                </div>
                <!-- Campaign Tab -->
            ...
            <footer class="footer d-block d-md-flex justify-content-between text-md-start text-center">
               <p class="mb-md-0 mb-1">Copyright &copy; <script type="45454cbb2a6d62bbcc825f12-text/javascript">document.write(new Date().getFullYear())</script> <a href="javascript:void(0);" class="link-primary text-decoration-underline">CRMS</a></p>
