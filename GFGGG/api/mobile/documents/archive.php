...
try {
    ...
    $stmt = $db->prepare("UPDATE documents SET statut = 'ARCHIVE', date_archivage = NOW() WHERE document_id = :id");
    $stmt->execute([':id' => $id]);
    ...
    echo json_encode(["status" => "success", "message" => "Document archive avec succes."]);
